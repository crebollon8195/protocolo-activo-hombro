          ...
          <div className="bg-white rounded-2xl shadow-soft p-8">
            {sent ? (
              <div className="text-center">
                ...
                <h1 className="text-xl font-primary font-semibold text-dark mb-2">Enlace enviado</h1>
                ...
                <Link href="/auth/login" className="inline-flex items-center gap-2 text-primary hover:text-dark font-primary font-semibold text-sm">
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <h1 className="text-xl font-primary font-semibold text-dark">{t("forgot_title")}</h1>
                  <p className="text-sm text-text-secondary mt-1 font-body">{t("forgot_subtitle")}</p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-primary hover:bg-dark text-white font-primary font-semibold py-2.5 rounded-xl" disabled={loading}>
                    {loading ? "Enviando..." : t("send_btn")}
                  </Button>
                </form>
                <div className="text-center mt-6">
                  <Link href="/auth/login" className="inline-flex items-center gap-1 text-sm text-primary hover:text-dark font-primary font-semibold">
                    <ArrowLeft className="w-4 h-4" />
                    {t("back_login")}
                  </Link>
                </div>
